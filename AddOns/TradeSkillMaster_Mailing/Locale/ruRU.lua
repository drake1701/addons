...
L["After the initial mailing, the auto-mail feature will automatically restart after however many minutes this slider is set to."] = "После начальной отправки, авто-отправка будет автоматически запускаться через указанные интервалы времени в минутах."
L["Are you sure you want to remove %s as a mail target?"] = "Вы точно хотите удалить получателя %s?"
...
L["AutoMail Restart Delay (minutes)"] = "Интервал запуска авто-отправки (минуты)"
L["AutoMail Send Delay"] = "Задержка между посылками"
...
L["Automatically Restart AutoMail"] = "Автоматическая авто-отправка"
...
L["Change Mail Target"] = "Изменить получателя"
...
L["New Player Name"] = "Новое имя игрока"
L["No player name entered."] = "Не введено имя персонажа."
L["Nothing to mail!"] = "Нечего отправлять!"
L["Old Player Name"] = "Старое имя игрока"
...
L["Please wait until you are done opening mail before sending mail."] = "Перед отправкой, пожалуйста, дождитесь окончания получения почты."
L["Remove Mail Target"] = "Удалить получателя"
L["Restarting AutoMail in %s minutes."] = "Перезапуск авто-отправки через %s минут."
