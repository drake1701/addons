...
function rematch:LockNotesCard(teamName,button)
	if button=="RightButton" then
		rematch:SetMenuSubject(teamName)
		rematch:ShowMenu("manageNotes","cursor")
	else
...
function rematch:NotesCardOnTextChanged()
	...
	local saved = RematchSaved[card.teamName][6]
