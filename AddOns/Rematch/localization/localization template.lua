...
--[[
--new strings in 3.3.7
"Save NPC ID (%d)"
"List %d \1244Team:Teams;"
"Team Tab Options"
"%s \124cffffd200moved to\124r \124T%s:14\124t %s"
"Battle Options"
"Require Shift to drag"
"Larger text"
"Pet Tab Options"
"Show after pet battle"
"The saved order will be lost and teams will be listed alphabetically again."
"When leaving a pet battle, automatically show the Rematch window."
"Spam when teams move"
"%s \1244Team:Teams;"
"Make the text in the scrollable lists (pets, teams and options) and menus a little bigger."
"Prefer live pets"
"Move to \124T%s:16\124t%s"
"Save a unique identifier for \124cffffffff%s\124r so Rematch will react only to this version of the NPC.\n\nIf an ID is not saved, Rematch will react to any targets that share this team's name.\n\nTeams with an NPC ID are listed in \124cffffffffWhite\124r.\nTeams without an NPC ID are listed in \124cffffd200Gold\124r."
"Save NPC ID with team"
"Display in your chat window when a team moves to another tab."
"Lock teams in place so they require holding Shift to drag them."
"Custom Sort"
"Remove custom sort?"
"Your pets are already at full health."

--removed strings in 3.3.7
"Make the text in the scrollable lists (pets, teams and options) a little bigger."
"Larger list text"
"Revert to the last saved notes. Changes are saved when leaving these notes."
"Pet Browser Options"
"Prefer Live Pets"
]]
...
-- save.lua
	...
	L["Save NPC ID with team"] = "Save NPC ID with team"
	L["Save NPC ID (%d)"] = "Save NPC ID (%d)"
	L["Save a unique identifier for \124cffffffff%s\124r so Rematch will react only to this version of the NPC.\n\nIf an ID is not saved, Rematch will react to any targets that share this team's name.\n\nTeams with an NPC ID are listed in \124cffffffffWhite\124r.\nTeams without an NPC ID are listed in \124cffffd200Gold\124r."] = "Save a unique identifier for \124cffffffff%s\124r so Rematch will react only to this version of the NPC.\n\nIf an ID is not saved, Rematch will react to any targets that share this team's name.\n\nTeams with an NPC ID are listed in \124cffffffffWhite\124r.\nTeams without an NPC ID are listed in \124cffffd200Gold\124r."
