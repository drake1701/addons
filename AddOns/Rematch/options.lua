...
rematch.optionsList = {
	...
	{ "check", "SpamTeamMove", L["Spam when teams move"]..newOption, L["Display in your chat window when a team moves to another tab."] },
	{ "check", "LockTeamDrag", L["Require Shift to drag"]..newOption, L["Lock teams in place so they require holding Shift to drag them."] },
