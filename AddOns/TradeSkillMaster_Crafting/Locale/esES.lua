...
L["Are you sure you want to delete the selected profile?"] = "¿Estas seguro que quieres borrar este perfil?"
L["Armor"] = "Armadura"
...
L["Can not set a max restock quantity below the minimum restock quantity of %d."] = "No se puede poner el Maximo restock por debajo del Minimo restock %d"
...
-- L["Craft Next"] = ""
-- L["Crafts"] = ""
L["Create a new empty profile."] = "Crear un perfil vacio."
...
L["Don't queue this item."] = "No encolar este Objeto"
L["Double Click Queue"] = "Doble Click para Encolar"
-- L["Edit Custom Value"] = ""
-- L["Elixir"] = ""
...
L["%s not queued! Min restock of %s is higher than max restock of %s"] = "%s no en cola! Min restock  de %s es mayor que max restock de %s"
-- L["Staff"] = ""
-- L["Status"] = ""
