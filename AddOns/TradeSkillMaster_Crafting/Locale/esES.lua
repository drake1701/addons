...
L["Add Item to New Group"] = "Añadir Objeto a Nuevo Grupo" -- Needs review
L["Add Item to Selected Group"] = "Añadir Objeto a un Grupo" -- Needs review
L["Add Item to TSM_Auctioning"] = "Añadir Objeto a TSM Auctioning" -- Needs review
L["Additional Item Settings"] = "Opciones Adicionales de Objetos" -- Needs review
L["Addon to use for alt data:"] = "Addon para usar los datos de Alters" -- Needs review
...
L["Allows you to set a custom minimum queue quantity for this item."] = "Te permite customizar el minimo Restock para este objeto." -- Needs review
...
L["Are you sure you want to delete the selected profile?"] = "¿Estas seguro que quieres borrar este perfil?" -- Needs review
-- L["Armor"] = ""
-- L["Armor - Back"] = ""
-- L["Armor - Chest"] = ""
-- L["Armor - Feet"] = ""
...
L["Can not set a max restock quantity below the minimum restock quantity of %d."] = "No se puede poner el Maximo restock por debajo del Minimo restock %d" -- Needs review
...
-- L["Craft Next"] = ""
-- L["Crafts"] = ""
L["Create a new empty profile."] = "Crear un perfil vacio." -- Needs review
-- L["Create Auctioning Groups"] = ""
L["Current Profile:"] = "Perfil Actual" -- Needs review
-- L["Custom"] = ""
-- L["Custom Value"] = ""
...
L["Don't queue this item."] = "No encolar este Objeto" -- Needs review
L["Double Click Queue"] = "Doble Click para Encolar" -- Needs review
-- L["Edit Custom Value"] = ""
-- L["Elixir"] = ""
-- L["Enable All Crafts"] = ""
L["Enable / Disable showing this craft in the craft management window."] = "Habilitar/Deshabilitar mostrar esta receta en la ventana de control." -- Needs review
...
L["%s not queued! Min restock of %s is higher than max restock of %s"] = "%s no en cola! Min restock  de %s es mayor que max restock de %s" -- Needs review
-- L["Staff"] = ""
-- L["Status"] = ""
