--[[ -- Needs to be upgraded to AceLocale-3.0, see Locale-enUS.lua
local L = AceLibrary("AceLocale-2.2"):new("AutoProfitX2")

L:RegisterTranslations("zhCN", function() return {
		--commands
		--["/AutoProfitX2"] = "/autoprofix",
		["/apx"] = "/apx",
		["options"] = "选项",
		...
		["Update exception list from pre 2.0 AutoProfitX2 version."] = "更新旧的例外物品列表",
