...
L.LIVESTOCK_FONTSTRING_HAWKHUNTERASPECTSLABEL = "Smart Mounting casts AotH when cancelling AotC / AotP."
L.LIVESTOCK_FONTSTRING_MOUNTHUNTERASPECTSLABEL = "Smart Mounting casts AotH when mounting."
...
L.LIVESTOCK_SPELL_CLOUDSERPENT = GetSpellInfo(130487)		-- "Cloud Serpent Riding"

L.LIVESTOCK_SPELL_SWIFTFLIGHTFORM = GetSpellInfo(40120)	-- "Swift Flight Form"
L.LIVESTOCK_SPELL_FLIGHTFORM = GetSpellInfo(33943)		-- "Flight Form"
...
L.LIVESTOCK_SPELL_HAWK = GetSpellInfo(13165)				-- "Aspect of the Hawk"
L.LIVESTOCK_SPELL_IRON_HAWK = GetSpellInfo(109260)		-- "Aspect of the Iron Hawk"
...
L.LIVESTOCK_SPELL_AQUATICFORM = GetSpellInfo(1066)		-- "Aquatic Form"
