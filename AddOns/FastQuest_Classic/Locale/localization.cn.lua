-- $Id: localization.cn.lua 149 2011-12-05 03:44:04Z arithmandar $
-- [[
-- Simplified Chinese
...
FQ_OPT_QUESTCOMPLETESOUND_TITLE		= "任务完成提示声音";
FQ_OPT_QUESTCOMPLETESOUND_TIP		= "启用 / 停用任务完成时的提示声音.";
...
FQ_OPT_NODRAG_TITLE			= "停用移动";
FQ_OPT_NODRAG_TIP			= "将任务追踪窗口设定为完全不可移动";
...
FQ_OPT_SOUNDSELECTION			= "提示声音: ";
FQ_BTN_OK				= "OK";
FQ_BTN_ABOUT				= "关于";
FQ_BTN_PREVIEW				= "预览";

FQ_BUTTON_TOOLTIP			= "鼠标左键开启任务窗口.\n鼠标中键开启 FastQuest Classic 选像窗口.\n鼠标右键并拖曳以移动图标按钮位置.";
FQ_TITAN_BUTTON_TOOLTIP			= "鼠标左键开启任务窗口.\n鼠标右键开启 FastQuest Classic 选像窗口.";
...
FQ_INFO_QUESTCOMPLETESOUND	= "任务完成时的通知提示声音: ";
FQ_INFO_MEMBERINFO 		= "显示任务建议的队伍人数信息: ";
FQ_INFO_NODRAG 			= "停用移动任务追踪窗口现在是: ";
