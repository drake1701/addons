-- $Id: localization.tw.lua 148 2011-12-05 03:20:34Z arithmandar $
-- [[
-- Traditional Chinese
...
FQ_OPT_QUESTCOMPLETESOUND_TITLE	= "任務完成提示聲音";
FQ_OPT_QUESTCOMPLETESOUND_TIP	= "啟用 / 停用任務完成時的提示聲音.";
...
FQ_OPT_NODRAG_TITLE		= "停用移動";
FQ_OPT_NODRAG_TIP		= "將任務追蹤視窗設定為完全不可移動";
...
FQ_OPT_SOUNDSELECTION		= "提示聲音: ";
FQ_BTN_OK			= "OK";
FQ_BTN_ABOUT			= "關於";
FQ_BTN_PREVIEW			= "預覽";

FQ_BUTTON_TOOLTIP		= "滑鼠左鍵開啟任務視窗.\n滑鼠中鍵開啟 FastQuest Classic 選像視窗.\n滑鼠右鍵並拖曳以移動圖示按鈕位置.";
FQ_TITAN_BUTTON_TOOLTIP		= "滑鼠左鍵開啟任務視窗.\n滑鼠右鍵開啟 FastQuest Classic 選像視窗.";
...
FQ_INFO_QUESTCOMPLETESOUND	= "任務完成時的通知提示聲音: ";
FQ_INFO_MEMBERINFO 		= "顯示任務建議的隊伍人數資訊: ";
FQ_INFO_NODRAG 			= "停用移動任務追蹤視窗現在是: ";
