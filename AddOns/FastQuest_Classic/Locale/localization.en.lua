-- $Id: localization.en.lua 148 2011-12-05 03:20:34Z arithmandar $
-- [[
-- Language: English, and default language
-- Last Updated: $Date: 2011-12-05 11:20:34 +0800 (Mon, 05 Dec 2011) $
-- ]]
--------------------------
...
EPA_TestPatterns = {
	"^(.+): %s*[-%d]+%s*/%s*[-%d]+%s*$",
	"^(.+)[^Trade]completed.$",				-- ERR_QUEST_COMPLETE_S: "%s completed.", we need to exclude the "Trade" to fall into this comparison
	"^(.+)\(Complete\)$",					-- ERR_QUEST_OBJECTIVE_COMPLETE_S: "%s (Complete)"
--	"^Quest accepted: .+$",					-- ERR_QUEST_ACCEPTED_S: "Quest accepted: %s"
	"^Experience gained: .+$",				-- ERR_QUEST_REWARD_EXP_I: "Experience gained: %d."
	"^Discovered: .+$",					-- ERR_ZONE_EXPLORED: "Discovered: %s"
};
--
...
FQ_OPT_QUESTCOMPLETESOUND_TITLE	= "Quest Complete Sound";
FQ_OPT_QUESTCOMPLETESOUND_TIP	= "Enable / Disable the notification sound when a quest is being completed.";
...
FQ_OPT_SOUNDSELECTION		= "Notification Sound: ";
FQ_BTN_OK			= "OK";
FQ_BTN_ABOUT			= "About";
FQ_BTN_PREVIEW			= "Preview";

FQ_BUTTON_TOOLTIP		= "Left-click to open Quest Log.\nMiddle-click for FastQuest Classic options.\nRight-click and drag to move this button.";
FQ_TITAN_BUTTON_TOOLTIP		= "Left-click to open Quest Log.\nRight-click for FastQuest Classic options.";
...
FQ_QUEST_ACCEPTED	= "Quest Accepted: ";
--
