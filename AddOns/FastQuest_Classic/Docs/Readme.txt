...
==========
    ...
    * Quest completion notification sound now is customizable. User can replace
      the notification sound with any sound they like. Simply find the sound
      in "Sounds\QuestComplete.mp3" and replace it.
    * With FastQuest Classic, now it will make the QuestLogFrame and WatchFrame 
      to be dragable.
